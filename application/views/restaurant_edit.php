...
<div class="col-md-4 col-md-offset-4">
    ...
    <form name="restaurant_edit" method="post" action="<?php echo site_url().'Restaurant/restaurant_edit_data'; ?>">
          ...
          <input class="form-control input-sm"type="text"  id="RestaurantOpenHours"  name="RestaurantOpenHours" maxlength="5"> <br>
          <input class="form-control input-sm"type="text"  id="RestaurantOpenHours2" name="RestaurantOpenHours2" maxlength="5"><br>
          <input class="form-control input-sm"type="text"  id="RestaurantOpenHours3" name="RestaurantOpenHours3" maxlength="5"><br>
          <input class="form-control input-sm"type="text"  id="RestaurantOpenHours4" name="RestaurantOpenHours4" maxlength="5"><br>
          <input class="form-control input-sm"type="text"  id="RestaurantOpenHours5" name="RestaurantOpenHours5" maxlength="5"><br>
          <input class="form-control input-sm"type="text"  id="RestaurantOpenHours6" name="RestaurantOpenHours6" maxlength="5"><br>

...
(
   ...
   RESTAURANT_IMAGE, RESTAURANT_LATITUDE, RESTAURANT_LONGITUDE NVARCHAR2(200) default 'placeholder.jpg',
...
'-7.9088937');
INSERT INTO Restaurants (RESTAURANT_NAME,RESTAURANT_ADDRESS,RESTAURANT_COORDS,RESTAURANT_OPEN_HOURS,RESTAURANT_RESERVATIONS,RESTAURANT_WIFI,
RESTAURANT_DELIVERY,RESTAURANT_MULTIBANCO,RESTAURANT_OUTDOOR_SEATING,RESTAURANT_POINTS,RESTAURANT_IMAGE, RESTAURANT_LATITUDE, RESTAURANT_LONGITUDE, RESTAURANT_LATITUDE, RESTAURANT_LONGITUDE)
values(
'CB House',
'Viseu',
...
*/
-- insert USERS
-- pode e nao dar a palavra passe

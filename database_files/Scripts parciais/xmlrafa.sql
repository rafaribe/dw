...
-- a string com o respectivo numero de caracteres. O conte�do do Reference tem de come�ar por A, tendo quaisquers caracteres a seguir.
...
-- Esta tabela faz a rela��o entre a tabela XML purchaseorder e a tabela relacional employees, comparando o elemento XML '$p/PurchaseOrder/User'
...
-- A funcionalidade de XML Table � de mapear a
